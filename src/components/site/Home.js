  ...
  return (
    <div className="main">
      <div className="mainDiv">
        ...
        <p>
          This app is intended to be a starter/tutorial ap p for your upcoming
          project and a learning sandbox for you in months and years to come
          should you continue to developer software with React. In this
        ...
        <ul>
          ...
          <li>
            This app simply scratches this surface on what is possible with
            React.
          </li>
          <li>
